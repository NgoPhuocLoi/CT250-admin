  ...
  <div class="w-[90%] flex flex-col gap-6">
    <div class="flex flex-col gap-6">
      ...
      <div class="flex flex-col gap-2">
        ...
        <div>
          <div v-for="category in categoryStore.categories" :key="category.id">
            <input
              class="mr-2"
              v-model="productStore.parentCategoryId"
              type="radio"
              :id="category.id"
              @click="productStore.newProduct.categoryId = 0"
              name="parentCategory"
              :value="category.id"
            />
        ...
        <select
          v-model="productStore.newProduct.categoryId"
        ...
        >
          ...
          <optgroup
            v-for="subCategory1 in productStore.parentCategory?.children"
            :key="subCategory1.id"
      ...
      <div class="flex flex-col gap-2">
        ...
        <div>
          <input
            class="mr-2"
            v-model="productStore.newProduct.visible"
            type="radio"
            id="visible"
            name="visibility"
            value="true"
    ...
    <div class="grid grid-cols-2 gap-3">
      <div class="col-span-1 flex flex-col gap-2">
        ...
        <ckeditor
          name="description"
          :editor="editor"
          v-model="productStore.newProduct.description"
        ></ckeditor>
      ...
      <div class="col-span-1 flex flex-col gap-2">
        ...
        <ckeditor
          name="overview"
          :editor="editor"
          v-model="productStore.newProduct.overview"
        ></ckeditor>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div class="col-span-1 flex flex-col gap-2">
        ...
        <ckeditor
          name="material"
          :editor="editor"
          v-model="productStore.newProduct.material"
        ></ckeditor>
      ...
      <div class="col-span-1 flex flex-col gap-2">
        ...
        <ckeditor
          name="instruction"
          :editor="editor"
          v-model="productStore.newProduct.instruction"
        ></ckeditor>
    ...
    <div class="flex flex-col gap-2">
      ...
      <div class="grid grid-cols-4 gap-2 border rounded p-4">
        <div
          v-for="(image, index) of productStore.images"
          :key="image.file.name"
          class="relative ol-span-1 flex items-center justify-center border-2 border-dashed border-slate-200"
        >
          <img
            class="w-full object-contain overflow-hidden"
            :src="image.path"
          />
          <div class="cursor-pointer flex gap-1 absolute top-2 right-2">
            <EditIcon
              @click="productStore.uploadImage(`editProductImage_${index}`)"
            />
            <DeleteIcon
              class=""
              @click.prevent="productStore.removeProductImage(index)"
            />
        ...
        <div
          @click="productStore.uploadImage('productImages')"
        ...
        >
          ...
          <div class="absolute top-0 left-0 invisible">
            <input
              ...
              type="file"
              id="productImages"
              @change="productStore.addProductImage"
              multiple
            />
          </div>
        </div>
