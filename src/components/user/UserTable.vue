...
const fetchAccounts = async () => {
  ...
  try {
    ...
    accounts.value = res.metadata.map((account) => {
      return {
        ...account,
        role: roleMapping[account.roleId],
      };
    });
  } catch (error) {
    console.log(error);
    ...
    >
      ...
      <Column field="id" header="Mã người dùng" sortable>
        <template #body="slotProps">
          <RouterLink
            :to="`/nguoi-dung/${slotProps.data.id}`"
      ...
      <Column field="role" header="Quyền" sortable>
        <template #body="slotProps">
          <Tag
          ...
          >
            <template #option="slotProps">
              <Tag
                ...
                :severity="
                  slotProps.option === 'Admin'
                    ? 'primary'
                    : slotProps.option === 'Nhân viên'
                    ? 'info'
                    : 'secondary'
                "
              />
